...
dataset <- read.csv(file.path(nca_output_dir, "DMTHAR_HAR.csv"))
...
write.csv(nca_results_full, file.path(nca_output_dir, "nca_results_full_HAR.csv"))
write.csv(AUC_timewindow, file.path(nca_output_dir, "nca_results_AUC_180_HAR.csv"))
